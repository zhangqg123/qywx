...
public class WeixinCoreController {
	...
	public void wechatPost(HttpServletResponse response,
		...
		try {
			...
			System.out.println("...appid..."+appid+"....dealMap...."+dealMap);
//			request.getSession().setAttribute("agentId", appid);
...
//			request.getSession().setAttribute("qyuserid", dealMap.get("FromUserName"));
