...
public interface QywxGzuserinfoDao{
	...
	@ResultType(QywxGzuserinfo.class)
	public MiniDaoPage<QywxGzuserinfo> getJustAll(@Param("qywxGzuserinfo") QywxGzuserinfo qywxGzuserinfo,@Param("page")  int page,@Param("rows") int rows);

	@ResultType(QywxGzuserinfo.class)
	public MiniDaoPage<QywxGzuserinfo> getGroup(@Param("qywxGzuserinfo") QywxGzuserinfo qywxGzuserinfo,@Param("page")  int page,@Param("rows") int rows);

	@ResultType(QywxGzuserinfo.class)
	public MiniDaoPage<QywxGzuserinfo> getByDepartments(@Param("qywxGzuserinfo") QywxGzuserinfo qywxGzuserinfo,@Param("page")  int page,@Param("rows") int rows);
	
//	@Sql("select * from qywx_gzuserinfo qg where NOT EXISTS (SELECT 1 FROM notice_article_record nar WHERE nar.userid = qg.userid and nar.articleid=:articleid)")
	@ResultType(QywxGzuserinfo.class)
	public MiniDaoPage<QywxGzuserinfo> getNotin(@Param("qywxGzuserinfo") QywxGzuserinfo qywxGzuserinfo, @Param("articleid") String articleid,@Param("page")  int page,@Param("rows") int rows);

	@ResultType(QywxGzuserinfo.class)
	public MiniDaoPage<QywxGzuserinfo> getNotinAll(@Param("articleid") String articleid,@Param("page")  int page,@Param("rows") int rows);
	...
	//
	public List<QywxGzuserinfo> getByUserids(@Param("userids") String userids);
