...
SET 
	   ...
	   <#if qywxAgent.agentSecret ?exists && qywxAgent.agentSecret ?length gt 0>
		  ,agent_secret = :qywxAgent.agentSecret
		</#if>
	   <#if qywxAgent.accessToken ?exists && qywxAgent.accessToken ?length gt 0>
		  ,access_token = :qywxAgent.accessToken
		</#if>
	   ...
	   <#if qywxAgent.updateBy ?exists>
	    ...
	    <#if qywxAgent.jsTicket ?exists>
		   ,js_ticket = :qywxAgent.jsTicket
		</#if>
