...
public interface QywxMenuDao{
	 ...
	 * @return
	 */
	@Sql("SELECT * FROM QYWX_MENU WHERE MENU_KEY = :menuKey AND AGENT_ID = :agentId" )
	QywxMenu getMenuByMenuKeyAndAgentId(@Param("menuKey") String menuKey,@Param("agentId") String agentId);
